...
- Create the database:
  ...
  - Run the code in workbench. (click the lightning symbol in the workbench)
...
![Initial-Start](imagepath to this .md)

### User Input
Follow the meesage show in the terminal to enter corresponding input
